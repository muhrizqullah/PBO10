...
public class HighScore implements Serializable {
	...
	private static void initializeFile() {
		/*
		 * HighScore[] h={new HighScore(0,0," "),new HighScore(0,0," "),new
		 * HighScore(0,0," "), new HighScore(0,0," "),new HighScore(0,0," "),new
		 * HighScore(0,0," "), new HighScore(0,0," "),new HighScore(0,0," "),new
		 * HighScore(0,0," "), new HighScore(0,0," ")};
		 */

		HighScore[] h = { new HighScore(0, " "), new HighScore(0, " "), new HighScore(0, " "), new HighScore(0, " "),
